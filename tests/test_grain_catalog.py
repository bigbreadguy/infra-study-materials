...
class SelectCatalogDocumentTest(unittest.TestCase):
...
class CollectUniqueGrainTargetsTest(unittest.TestCase):
    def test_unions_every_category_without_duplicate_pairs(self):
        try:
            targets = collect_unique_grain_targets()
        except FileNotFoundError:
            self.skipTest("local grain target config files are not present")
